...
var centerMenu = [
    ...
    ,{
        name: '出售房屋收藏',
        url: '../chushoufangwuCollection/list.html'
    }
    ,{
        name: '预约出售房屋看房',
        url: '../chushoufangwuOrder/list.html'
    }
    ,{
        name: '租房收藏',
        url: '../zufangCollection/list.html'
    }
    ,{
        name: '预约租房看房',
        url: '../zufangOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '出售房屋',
        url: './pages/chushoufangwu/list.html'
    },
    {
        name: '租房',
        url: './pages/zufang/list.html'
    },

]

var adminurl =  "http://localhost:8080/fangwujiaoyipingtai/admin/dist/index.html#/login";
