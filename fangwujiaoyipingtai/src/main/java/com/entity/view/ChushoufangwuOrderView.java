...
public class ChushoufangwuOrderView extends ChushoufangwuOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String chushoufangwuOrderYesnoValue;
	...
	public ChushoufangwuOrderView() {

	}

	public ChushoufangwuOrderView(ChushoufangwuOrderEntity chushoufangwuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, chushoufangwuOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getChushoufangwuOrderYesnoValue() {
				return chushoufangwuOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setChushoufangwuOrderYesnoValue(String chushoufangwuOrderYesnoValue) {
				this.chushoufangwuOrderYesnoValue = chushoufangwuOrderYesnoValue;
			}
