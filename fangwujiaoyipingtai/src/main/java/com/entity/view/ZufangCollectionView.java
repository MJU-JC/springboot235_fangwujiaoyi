...
public class ZufangCollectionView extends ZufangCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String zufangCollectionValue;
	...
	public ZufangCollectionView() {

	}

	public ZufangCollectionView(ZufangCollectionEntity zufangCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zufangCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getZufangCollectionValue() {
				return zufangCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setZufangCollectionValue(String zufangCollectionValue) {
				this.zufangCollectionValue = zufangCollectionValue;
			}
