...
public class ZufangOrderView extends ZufangOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String zufangOrderYesnoValue;
	...
	public ZufangOrderView() {

	}

	public ZufangOrderView(ZufangOrderEntity zufangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, zufangOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getZufangOrderYesnoValue() {
				return zufangOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setZufangOrderYesnoValue(String zufangOrderYesnoValue) {
				this.zufangOrderYesnoValue = zufangOrderYesnoValue;
			}
