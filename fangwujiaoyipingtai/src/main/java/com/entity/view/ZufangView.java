 ...
 */
@TableName("zufang")
public class ZufangView extends ZufangEntity implements Serializable {
	...
	public ZufangView(ZufangEntity zufangEntity) {
		try {
			BeanUtils.copyProperties(this, zufangEntity);
