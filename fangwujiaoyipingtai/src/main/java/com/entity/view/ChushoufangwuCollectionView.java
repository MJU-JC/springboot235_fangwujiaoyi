...
public class ChushoufangwuCollectionView extends ChushoufangwuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String chushoufangwuCollectionValue;
	...
	public ChushoufangwuCollectionView() {

	}

	public ChushoufangwuCollectionView(ChushoufangwuCollectionEntity chushoufangwuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chushoufangwuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChushoufangwuCollectionValue() {
				return chushoufangwuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChushoufangwuCollectionValue(String chushoufangwuCollectionValue) {
				this.chushoufangwuCollectionValue = chushoufangwuCollectionValue;
			}
