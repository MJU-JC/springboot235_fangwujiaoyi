...
public class ChushoufangwuEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChushoufangwuEntity() {

	}

	public ChushoufangwuEntity(T t) {
		try {
    ...
    public String toString() {
        return "Chushoufangwu{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", chushoufangwuName=" + chushoufangwuName +
            ", chushoufangwuUuidNumber=" + chushoufangwuUuidNumber +
            ", chushoufangwuPhoto=" + chushoufangwuPhoto +
            ", chushoufangwuTypes=" + chushoufangwuTypes +
            ", chushoufangwuXinjiuTypes=" + chushoufangwuXinjiuTypes +
            ", quyuTypes=" + quyuTypes +
            ", chushoufangwuXiaoqu=" + chushoufangwuXiaoqu +
            ", chushoufangwuWeizhi=" + chushoufangwuWeizhi +
            ", chushoufangwuMianji=" + chushoufangwuMianji +
            ", chushoufangwuOldMoney=" + chushoufangwuOldMoney +
            ", chushoufangwuNewMoney=" + chushoufangwuNewMoney +
            ", chushoufangwuClicknum=" + chushoufangwuClicknum +
            ", chushoufangwuContent=" + chushoufangwuContent +
            ", chushoufangwuZhuangtaiTypes=" + chushoufangwuZhuangtaiTypes +
            ", shangxiaTypes=" + shangxiaTypes +
            ", chushoufangwuDelete=" + chushoufangwuDelete +
