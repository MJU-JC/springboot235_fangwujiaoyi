...
public class ChushoufangwuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChushoufangwuLiuyanEntity() {

	}

	public ChushoufangwuLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "ChushoufangwuLiuyan{" +
            "id=" + id +
            ", chushoufangwuId=" + chushoufangwuId +
            ", yonghuId=" + yonghuId +
            ", chushoufangwuLiuyanText=" + chushoufangwuLiuyanText +
